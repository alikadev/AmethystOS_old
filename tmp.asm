...
disk_error:
	...
	call 	putx 									; Print the error code
...
s_welcome: 			db "DiskID=", 0
s_search_boot_bin:	db "Search BOOT.BIN", 0xA, 0
s_load_boot_bin:	db "Load BOOT.BIN", 0xA, 0
s_exec_boot_bin:	db "Exec BOOT.BIN", 0xA, 0
s_err_disk_read: 	db "E:Read=", 0
s_err_not_found:	db "E:NotFound", 0
