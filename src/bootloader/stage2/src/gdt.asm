...
; Access Byte = 0x9A
; Flags       = 0xC
.code16_segment: dw 0xFFFF    ; Limit   0-15
                 dw 0         ; Base    0-15
                 db 0         ; Base   16-23
                 db 10011010b ; Access  9-7
                 db 00001111b ; Limit  16-24
                              ; Flags   0-8
                 db 0         ; Base   24-31
...
; Access Byte = 0x92
; Flags       = 0xC
.data16_segment: dw 0xFFFF    ; Limit   0-15
                 dw 0         ; Base    0-15
                 db 0         ; Base   16-23
                 db 10010010b ; Access  9-7
                 db 00001111b ; Limit  16-24
...
CODE16_SEG equ GDT.code16_segment - GDT
DATA16_SEG equ GDT.data16_segment - GDT